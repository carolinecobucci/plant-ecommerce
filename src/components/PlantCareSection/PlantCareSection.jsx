      ...
      <div className={styles.section_container}>
        <div className={styles.title}>
          ...
          <p className={styles.sub_title}>
            ...
            essential nutrients - you&apos;ll be well on your way to maintaining healthy and
            thriving plants.
          </p>
        </div>
        ...
        <div className={styles.plant_photos}>
          ...
          <div className={styles.see_more_photos}>
            ...
            <p>
              ...
              you with everything you need to nurture your plants and achieve gardening success. But
              we don&apos;t stop there! We believe that knowledge is the key to a thriving garden,
              so we offer a wealth of information and resources on gardening techniques, plant care
              tips, and landscaping ideas. Whether you&apos;re a seasoned gardener or just starting
              your green journey, our goal is to inspire and support you every step of the way. Get
