    ...
    <div>
      ...
      <div className={styles.developers}>
        <div className={styles.developers_profile}>
          <img className={styles.dev_img} src={carolProfile} alt="developer profile picture" />
        ...
        <div className={styles.developers_profile}>
          <img className={styles.dev_img} src={lucasProfile} alt="developer profile picture" />
          <h2>Lucas Gauto</h2>
        </div>
        <div className={styles.developers_profile}>
          <img className={styles.dev_img} src={taisProfile} alt="developer profile picture" />
          <h2>Tais Gehlen</h2>
        </div>
        <div className={styles.developers_profile}>
          <img className={styles.dev_img} src={thatyaraProfile} alt="developer profile picture" />
          <h2>Thatyara Gomes</h2>
        </div>
        <div className={styles.developers_profile}>
          <img className={styles.dev_img} src={viniCoelhoProfile} alt="developer profile picture" />
          <h2>Vinicius Coelho</h2>
        </div>
        <div className={styles.developers_profile}>
          <img
            className={styles.dev_img}
            src={viniMarquesProfile}
